 ...
 * <ul>
 *   <li>{@link scenarioDiagram.impl.ConsumerImpl#getServiceLinks <em>Service Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConsumerImpl extends ScenarioElementImpl implements Consumer {
	/**
	...
	protected EClass eStaticClass() {
		return ScenarioDiagramPackage.Literals.CONSUMER;
	}
	...
	public EList<ServiceLink> getServiceLinks() {
		if (serviceLinks == null) {
			serviceLinks = new EObjectWithInverseResolvingEList<ServiceLink>(ServiceLink.class, this, ScenarioDiagramPackage.CONSUMER__SERVICE_LINKS, ScenarioDiagramPackage.SERVICE_LINK__ACTOR);
		}
		return serviceLinks;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScenarioDiagramPackage.CONSUMER__SERVICE_LINKS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Actor.class) {
			switch (derivedFeatureID) {
				case ScenarioDiagramPackage.CONSUMER__SERVICE_LINKS: return ScenarioDiagramPackage.ACTOR__SERVICE_LINKS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Actor.class) {
			switch (baseFeatureID) {
				case ScenarioDiagramPackage.ACTOR__SERVICE_LINKS: return ScenarioDiagramPackage.CONSUMER__SERVICE_LINKS;
				default: return -1;
			}
		}
