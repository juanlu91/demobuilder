	...
	protected void createGmf_2Annotations() {
		...
		addAnnotation
		  (customerEClass, 
		   ...
		   new String[] {
			 "figure", "svg",
			 "svg.uri", "platform:/plugin/demobuilder/icons/Customer.svg",
			 "label", "name",
			 "tool.description", "Customer",
			 "label.placement", "external",
			 "label.icon", "false",
			 "size", "100,100",
			 "tool.small.bundle", "demobuilder.edit",
			 "tool.small.path", "/icons/full/obj16/Customer.gif",
			 "tool.large.bundle", "demobuilder.edit",
		...
		addAnnotation
		  (providerEClass, 
		   ...
		   new String[] {
			 "figure", "svg",
			 "svg.uri", "platform:/plugin/demobuilder/icons/Provider.svg",
			 "label", "name",
		...
		addAnnotation
		  (serviceNeedEClass, 
		   ...
		   new String[] {
			 "figure", "svg",
			 "svg.uri", "platform:/plugin/demobuilder/icons/serviceNeed.svg",
			 "label", "name",
			 "label.placement", "external",
			 "label.icon", "false",
		...
		addAnnotation
		  (serviceOfferEClass, 
		   ...
		   new String[] {
			 "figure", "svg",
			 "svg.uri", "platform:/plugin/demobuilder/icons/serviceOffer.svg",
			 "label", "name",
			 "label.placement", "external",
			 "label.icon", "false",
