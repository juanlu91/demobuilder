 ...
 * @model annotation="gmf.node figure='svg' svg.uri='platform:/plugin/demobuilder/icons/serviceNeed.svg' label='name' label.placement='external' label.icon='false' tool.description='Service Need' size='50,50' tool.small.bundle='demobuilder.edit' tool.small.path='/icons/full/obj16/ServiceNeed.gif' tool.large.bundle='demobuilder.edit' tool.large.path='/icons/full/obj32/ServiceNeed.gif'"
 * @generated
 */
