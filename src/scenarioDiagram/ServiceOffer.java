 ...
 * @model annotation="gmf.node figure='svg' svg.uri='platform:/plugin/demobuilder/icons/serviceOffer.svg' label='name' label.placement='external' label.icon='false' tool.description='Service Offer' size='50,50' tool.small.bundle='demobuilder.edit' tool.small.path='/icons/full/obj16/ServiceOffer.gif' tool.large.bundle='demobuilder.edit' tool.large.path='/icons/full/obj32/ServiceOffer.gif'"
 * @generated
 */
