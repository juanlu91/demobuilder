...
public class AgreementMetamodelPackageImpl extends EPackageImpl implements AgreementMetamodelPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getContext_Actors(), this.getActor(), null, "actors", null, 2, 2, Context.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMetric_Domain(), this.getDomain(), null, "domain", null, 1, 1, Metric.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
